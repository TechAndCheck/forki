...
class VideoSieveReelTest < Minitest::Test
  def setup
    @valid_json = JSON.parse(File.read("test/sieves/video_sieves/test_data/video_sieve_reel_valid.json"))
    @invalid_json = JSON.parse(File.read("test/sieves/video_sieves/test_data/video_sieve_reel_invalid.json"))
  end
